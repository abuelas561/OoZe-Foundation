...
/**
   ...
   2% distribute to a selected wallet  
   3% distributed to holders
   ttl supply = 8000000000 
   decimals 9
*/
...
contract $Drip is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x6E02425bFC33aD0c9e1d74B106e72F06c2CC8Cbf ;
    ...
    string private _name = "OoZe Token";
